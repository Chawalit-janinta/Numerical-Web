...
class false_position extends Component {
    ...
    exam() {
        ...
        axios.get('http://192.168.99.100:5000/falseposition/')
            .then(response => {
    ...
    save() {
        if (this.state.value != '' && this.state.xl.length > 1 && this.state.xr.length > 1) {
            ...
            axios.post('http://192.168.99.100:5000/falseposition/add', eq)
    ...
    plot() {
        /*const x_plot = this.state.xm;
        const y_plot = this.state.fxm;*/
            ...
            <Router>
                ...
                <div style={{ width: "100%", height: "650px", float: "left", padding: "50px" }}>
                    <div className="formula-block" style={{ height: "400px", width: "40%", float: "left" }}>
                        <h1 style={{ fontSize: "50px", fontWeight: "400" }}>False Position Method</h1>
                        <MDBFormInline>
