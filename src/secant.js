...
class secant extends Component {
    ...
    exam() {
        ...
        axios.get('http://localhost:5000/secant/')
            .then(response => {
                ...
                this.state.x1[0] = parseFloat(response.data[response.data.length - 1].x1);
                ...
                console.log(response.data[response.data.length - 1].equation,
                    ...
                    response.data[response.data.length - 1].x1);
                this.cal();
            })
            .catch((error) => {
                console.log(error);
    ...
    save() {
        if (this.state.value != '' && this.state.x0.length > 1 && this.state.x1.length > 1) {
            const eq = {
