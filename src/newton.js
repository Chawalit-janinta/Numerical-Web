...
class newton extends Component {
    ...
    exam() {
        ...
        axios.get('http://192.168.99.100:5000/newton/')
            .then(response => {
    ...
    save() {
        if (this.state.value != '' && this.state.x.length > 1 ) {
            ...
            axios.post('http://192.168.99.100:5000/newton/add', eq)
            ...
            <Router>
                ...
                <div style={{ width: "100%", height: "650px", float: "left", padding: "50px" }}>
                    <div className="formula-block" style={{ height: "400px", width: "40%", float: "left" }}>
                        <h1 style={{ fontSize: "45px", fontWeight: "400" }}>Newton-Raphson Method</h1>
                        <MDBFormInline>
